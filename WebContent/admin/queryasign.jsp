...
<body>
	<nav class="breadcrumb">
		...
		活动报名查询 <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px"
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="5">活动报名查询</th>
				</tr>
				<tr class="text-c">
			...
			<c:forEach items="${asignList}" var="asign">
				<tr class="text-c">
					...
					<td class="center">${asign.title}</td>
		...
		<div class="text-c">
			<form action="asign/queryAsignByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select">
						...
						<option value="activitiesid">按活动查询</option>
