...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-member">
			<dt>
				<i class="Hui-iconfont">&#xe62d;</i>活动用户信息管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
			</dt>
			<dd>
				<ul>
					<li><a data-href="users/getAllUsers.action" data-title="活动用户列表" href="javascript:void(0)">活动用户信息列表</a></li>
					<li><a data-href="users/queryUsersByCond.action" data-title="活动用户查询" href="javascript:void(0)">活动用户信息查询</a></li>
				</ul>
			</dd>
		</dl>
		...
		<dl id="menu">
			<dt>
				<i class="Hui-iconfont">&#xe62d;</i>活动项目信息管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
			</dt>
			<dd>
				<ul>
					<li><a data-href="activities/createActivities.action" data-title="新增活动项目" href="javascript:void(0)">新增活动项目信息</a></li>
					<li><a data-href="activities/getAllActivities.action" data-title="活动项目列表" href="javascript:void(0)">活动项目信息列表</a></li>
					<li><a data-href="activities/queryActivitiesByCond.action" data-title="活动项目查询" href="javascript:void(0)">活动项目信息查询</a></li>
				</ul>
			</dd>
		</dl>
