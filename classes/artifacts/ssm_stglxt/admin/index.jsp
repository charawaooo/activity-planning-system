...
<script type="text/javascript">
	function checkLogin() {
		...
		var captcha = document.myform.captcha.value;//new
		if (username == '') {
			alert('请输入用户名');
		...
		<div id="loginform" class="loginBox">
			<form class="form form-horizontal" action="admin/login.action" name="myform" method="post"
				...
				<div class="row cl">
					<label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe63f;</i></label>
					<div class="formControls col-xs-8">
						<input type="text" id="captcha" name="captcha" placeholder="请输入验证码" class="input-text size-L">
						<img src="${pageContext.request.contextPath}/index/captcha.action" alt="验证码" onclick="this.src='${pageContext.request.contextPath}/captcha?'+Math.random()">
					</div>
				</div>
				<div class="row cl">
