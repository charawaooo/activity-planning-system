...
public class UsersServiceImpl implements UsersService {
	...
	@Override//new继承接口的按主键查询 返回Entity实例
	public Users getUsersByUsername(String username) {
		return this.usersDAO.getUsersByUsername(username);
	}

	@Override//new继承接口的按主键查询 返回Entity实例
	public Users getUsersByUsernameAndContact(String username, String contact) {
		return this.usersDAO.getUsersByUsernameAndContact(username,contact);
	}
