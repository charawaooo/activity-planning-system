...
public class AdminController extends BaseController {
	...
	public String login() {
		...
		String captcha = this.getRequest().getParameter("captcha");//new

		HttpSession session = this.getRequest().getSession();//new
		String sessionCaptcha = (String) session.getAttribute("captcha");//new
	...
	public String editpwd() {
		...
		if (encryptedPassword.equals(admin.getPassword())) {
			admin.setPassword(md5(repassword));
